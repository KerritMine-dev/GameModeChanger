...
public class gm2 implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        p.setGameMode(GameMode.ADVENTURE); // Восстанавливаем 10 сердец, 1 сердце - 2 единицы.
        p.sendMessage(ChatColor.GREEN + "Гм2!"); // Сообщение игроку после восстановки.
        return true;
    }
}