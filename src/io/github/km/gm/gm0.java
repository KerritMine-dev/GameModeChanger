...
public class gm0 implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        p.setGameMode(GameMode.SURVIVAL); // Восстанавливаем 10 сердец, 1 сердце - 2 единицы.
        p.sendMessage(ChatColor.GREEN + "Гм0!"); // Сообщение игроку после восстановки.
        return true;
    }
}